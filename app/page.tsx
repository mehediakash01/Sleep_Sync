...
import { MotionLazy, MotionReveal } from "@/Components/home/MotionPrimitives";
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#0A1428] text-[#F5F0E8]">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {stars.map((star, index) => (
          <span
            key={star}
            className={`absolute ${star} h-1 w-1 rounded-full bg-white/70 shadow-[0_0_14px_rgba(255,255,255,0.5)] animate-[stardust_8s_ease-in-out_infinite]`}
      ...
      <MotionLazy>
        ...
        <section className="mx-auto grid min-h-screen max-w-7xl gap-16 px-6 pb-16 pt-32 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:pb-24 lg:pt-40">
          ...
          >
            ...
            <div className="space-y-6">
              <h1 className="text-5xl font-semibold leading-[0.95] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
                Sleep Better.
                <span className="mt-4 block">Live Better.</span>
              </h1>
          ...
          <MotionReveal
            ...
            y={28}
          >
            <div className="absolute left-0 top-20 hidden w-56 rounded-[28px] border border-white/12 bg-[#111B31]/80 p-5 backdrop-blur-2xl lg:block animate-[floatPanel_8s_ease-in-out_infinite]">
            ...
            <div className="absolute bottom-14 right-2 hidden w-64 rounded-[30px] border border-white/10 bg-[#121B32]/82 p-5 backdrop-blur-2xl lg:block animate-[floatPanelReverse_9s_ease-in-out_infinite]">
              ...
              <p className="text-sm leading-7 text-[#F5F0E8]/72">
                &ldquo;Your deep sleep rose 18% when screens ended before 10:30
                PM. Want a 12-minute wind-down tonight?&rdquo;
              </p>
            </div>

            <div
              id="dashboard-preview"
              className="relative w-full rounded-[40px] border border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.14),rgba(255,255,255,0.05))] p-4 shadow-[0_40px_120px_rgba(0,0,0,0.45)] backdrop-blur-2xl animate-[riseIn_0.9s_ease-out]"
            >
          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <MotionReveal className="space-y-6">
              ...
              <h2 className="text-4xl font-semibold tracking-[-0.03em] sm:text-5xl">
                A sleep platform designed to feel restorative before you even
                fall asleep.
              </h2>
              <p className="text-base leading-8 text-[#F5F0E8]/66 sm:text-lg">
                SleepSync keeps the interface calm, the insights practical, and
                the coaching grounded in what actually helps your nights improve.
              </p>
            </MotionReveal>

            <div className="grid gap-5 sm:grid-cols-2">
              {benefits.map(({ icon: Icon, title, body }, index) => (
                <MotionReveal key={title} delay={index * 0.06 + 0.04}>
                  <article
          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <MotionReveal className="space-y-6">
              ...
              <p className="text-base leading-8 text-[#F5F0E8]/66 sm:text-lg">
                ...
                distractions, better context, and interactions that support the
                reading experience instead of delaying it.
              </p>
            </MotionReveal>

            <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
              {features.map(({ icon: Icon, title, body }, index) => (
                <MotionReveal key={title} delay={index * 0.05 + 0.04}>
                  <article
                    className={`${shell} p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-[#00E5C2]/20 hover:shadow-[0_20px_64px_rgba(0,0,0,0.28)]`}
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#00E5C2]/10 text-[#00E5C2]">
        ...
        <section className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <MotionReveal className="mx-auto max-w-2xl space-y-4 text-center">
            <div className={eyebrow}>How It Works</div>
            <h2 className="text-4xl font-semibold tracking-[-0.03em] sm:text-5xl">
              Four calm steps from bedtime to better days.
            </h2>
            <p className="text-base leading-8 text-[#F5F0E8]/66 sm:text-lg">
              A simple flow that turns nightly logging into clearer mornings and
              more repeatable routines.
            </p>
          </MotionReveal>
          ...
          <div className="relative mt-14 grid gap-6 lg:grid-cols-4">
            ...
            {steps.map(([step, title, body], index) => (
              <MotionReveal key={step} delay={index * 0.06 + 0.02}>
                <article className={`${shell} relative p-7`}>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className={`${shell} bg-[#111B32]/80 p-6`}>
              <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
                <div className={`${shell} p-6`}>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#00E5C2]/12 text-[#00E5C2] shadow-[0_0_30px_rgba(0,229,194,0.18)] animate-[breathe_4s_ease-in-out_infinite]">
        ...
        <section className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
            <MotionReveal className={`${shell} bg-[#111B32]/80 p-6`}>
              <div
            ...
            <MotionReveal className="space-y-6" delay={0.08}>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {quotes.map(([quote, name, role], index) => (
              <MotionReveal key={name} delay={index * 0.07 + 0.03}>
                <article className={`${shell} p-7`}>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-28 pt-8 lg:px-8">
          <MotionReveal className="relative overflow-hidden rounded-[40px] border border-white/10 bg-[linear-gradient(135deg,rgba(30,27,75,0.86),rgba(76,43,140,0.7),rgba(0,229,194,0.14))] px-8 py-12 shadow-[0_28px_90px_rgba(0,0,0,0.35)] backdrop-blur-2xl sm:px-12 lg:px-16 lg:py-16">
